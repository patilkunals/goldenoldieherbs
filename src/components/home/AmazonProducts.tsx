    ...
    <section id="products" className="py-10 bg-sand">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {products.map(p => (
            <motion.article key={p.id} whileHover={{ y: -6 }} className="group rounded-2xl overflow-hidden bg-white border border-charcoal/5 shadow-sm hover:shadow-xl transition-all duration-300">
